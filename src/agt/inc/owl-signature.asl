...
combo_security_scheme(Individual) :- rdf(Individual, "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", "https://www.w3.org/2019/wot/security#ComboSecurityScheme") .
...
all_of(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/security#allOf", Individual2) .
authorization(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/security#authorization", Individual2) .
one_of(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/security#oneOf", Individual2) .
...
content_encoding(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/json-schema#contentEncoding", Individual2) .
content_media_type(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/json-schema#contentMediaType", Individual2) .
...
max_length(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/json-schema#maxLength", Individual2) .
...
min_length(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/json-schema#minLength", Individual2) .
minimum(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/json-schema#minimum", Individual2) .
multiple_of(Individual1, Individual2) :- rdf(Individual1, "https://www.w3.org/2019/wot/json-schema#multipleOf", Individual2) .
